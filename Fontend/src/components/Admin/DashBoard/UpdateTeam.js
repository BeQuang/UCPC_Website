                    ...
                    <div className="card mt-4">
                        <div className="card-body d-flex justify-content-between align-items-center">
                            ...
                            <div className="d-flex justify-content-between">
                                {show && (
                                    <button className="btn btn-primary btn-lg mx-4" style={{ fontSize: '1.5rem', padding: '1rem 2rem' }} onClick={handleHideHasNotUpdateTeams}>
                                        Hide
                                    </button>
                                )}
                                <button className="btn btn-primary btn-lg" style={{ fontSize: '1.5rem', padding: '1rem 2rem' }} onClick={handleGetHasNotUpdateTeams}>
                                    Get all
                                </button>
                            </div>
                        </div>
