                ...
                <div className={'overlay'}>
                    <div className={'title'}>
                        ...
                        <p>
                            ...
                            tincidunt. Vestibulum a ultricies risus. Aenean auctor sodales dolor non posuere. Vestibulum
                            nec nulla posuere, sollicitudin ligula.
                        </p>
                        <button className={'button'} onClick={handleRegister}>
                            {isAuthenticated ? 'Nộp lệ phí' : 'Đăng ký tham gia'}
                        </button>
                    </div>
                </div>
