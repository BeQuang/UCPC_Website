            ...
            <div className={cx('list-info')}>
                <div className={cx('info-item')}>
                    <div className={cx('content')}>
                        <p className={cx('title')}>Với sự tham gia của</p>
                        <p className={cx('year')}>XX</p>
                        <p>Đơn vị trường học</p>
                    </div>
                </div>
                <div className={cx('info-item', 'active')}>
                    <div className={cx('content')}>
                        <p className={cx('title')}>Được tổ chức từ</p>
                        <p className={cx('year')}>2014</p>
                    </div>
                </div>
                <div className={cx('info-item')}>
            ...
            <div className={cx('body')}>
                <div className={cx('content')}>
                    <img
                        ...
                        className={cx('logo')}
                    />
                    <h1 className={cx('title')}>UCPC 2024</h1>
